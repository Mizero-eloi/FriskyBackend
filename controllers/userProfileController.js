...
module.exports.userProfile = async (req, res, next) => {
  ...
  if (req.user._id != req.params.userId) return res.status(403).send("You are not authorised to perform this action");
...
module.exports.updateUserProfilePicture = async (req, res, next) => {
    await updateCollection(User, req.params.userId, {"profile": req.file.path}, res);
}